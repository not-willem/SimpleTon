...
2. Unzip it, then run "st.py". it should tell you what libraries are missing. hold off till i make a requirements.txt lmao
   
also get pygame-ce, not regular pygame because pygame is outdated

3. After you install the libraries, it should bring you to a terminal that you can quit easily by pressing ctrl+c
